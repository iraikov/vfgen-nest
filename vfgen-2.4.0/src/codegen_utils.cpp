...
static char *datetimefmt = "Generated on %2d-%3s-%04d at %02d:%02d";
...
void PrintVFGENComment(ofstream &fout, char *prefix)
    {
...
void MakeCArrayOfStrings(ofstream &fout, char *var, lst names)
    {
    int n;
...
void MakePythonListOfStrings(ofstream &fout, char *var, lst names, char *pre)
    {
    int n;
...
void GetFromVector(ofstream &fout, char *skip, lst names, const char *vector,
...
void GetFromVector2(ofstream &fout, char *skip, lst names, char *vector,
...
void SetVectorFromNames(ofstream &fout, char *skip, const char *vector, lst names,
                      char *braces, int istart, char *term)
    {
    int n;
