...
char *DateTimeMsg();
void PrintVFGENComment(std::ofstream &fout, char *prefix);
...
void GetFromVector(std::ofstream &fout, char *skip, GiNaC::lst names, const char *vector,
                      char *braces, int istart, char *term);
void GetFromVector2(std::ofstream &fout, char *skip, GiNaC::lst names, char *vector,
                      char *bropen, char *brclose, int istart, char *term);
